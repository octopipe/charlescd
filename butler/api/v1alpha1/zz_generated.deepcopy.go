...
func (in *CircleStatus) DeepCopyInto(out *CircleStatus) {
	*out = *in
	if in.Modules != nil {
		in, out := &in.Modules, &out.Modules
		*out = make(map[string]CircleModuleStatus, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DefaultDeployStartegy) DeepCopyInto(out *DefaultDeployStartegy) {
	*out = *in
	if in.CustomMatch != nil {
		in, out := &in.CustomMatch, &out.CustomMatch
		*out = new(CircleMatch)
		(*in).DeepCopyInto(*out)
	}
	if in.Segments != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DefaultDeployStartegy.
func (in *DefaultDeployStartegy) DeepCopy() *DefaultDeployStartegy {
	if in == nil {
		return nil
	}
	out := new(DefaultDeployStartegy)
