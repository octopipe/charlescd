      ...
      >
        <Nav variant='pills' defaultActiveKey={basicMetricType} onSelect={key => setBasicMetricType(key || '')} className='mb-3'>
          ...
          {metrics?.filter((metric: any) => metric.id == basicMetricType)?.map((metric: any) => (
            <>
              <Nav variant='pills' defaultActiveKey={metricRange} onSelect={key => setMetricRange(key || '30m')} className='mb-3'>
                <Nav.Item><Nav.Link eventKey="15m">15 minutes</Nav.Link></Nav.Item>
                <Nav.Item><Nav.Link eventKey="30m">30 minutes</Nav.Link></Nav.Item>
                <Nav.Item><Nav.Link eventKey="1h">1 hour</Nav.Link></Nav.Item>
                <Nav.Item><Nav.Link eventKey="3h">3 hours</Nav.Link></Nav.Item>
              </Nav>
